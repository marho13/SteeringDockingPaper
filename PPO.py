...
# #Cuda if exists, good for certain scenarios
    ...
    def __init__(self, state_dim, action_dim, has_continuous_action_space, action_std_init):
        ...
        if has_continuous_action_space:
            self.actor = nn.Sequential(
                ...
                nn.Tanh()   #Normally tanh, but because the actionspace is [-1, 1],[0, 1], [0, 1]
                            # action[1]&[2] cannot be negative, the steering script will fix it
